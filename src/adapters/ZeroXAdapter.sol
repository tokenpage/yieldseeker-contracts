...
contract YieldSeekerZeroXAdapter is YieldSeekerAdapter {
    ...
    function swap(address target, address sellToken, address buyToken, uint256 sellAmount, uint256 minBuyAmount, bytes calldata swapCallData, uint256 value) external payable returns (uint256 buyAmount) {
